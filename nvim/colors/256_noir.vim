...
if has("gui_running") || &t_Co == 256
	...
	hi SpellRare	ctermfg=124	ctermbg=0	guifg=#af0000	guibg=#000000
	hi Character	ctermfg=196	ctermbg=0	guifg=#ff0000	guibg=#000000
	hi Condtional	ctermfg=196	ctermbg=0	guifg=#ff0000	guibg=#000000
	hi Float	ctermfg=196	ctermbg=0	guifg=#ff0000	guibg=#000000
	hi Folded	ctermfg=196	ctermbg=0	guifg=#ff0000	guibg=#000000
	hi Number	ctermfg=196	ctermbg=0	guifg=#ff0000	guibg=#000000
	hi Tag	ctermfg=196	ctermbg=0	guifg=#ff0000	guibg=#000000
	hi WarningMsg	ctermfg=196	ctermbg=0	guifg=#ff0000	guibg=#000000
	hi Comment	ctermfg=240	ctermbg=0	guifg=#585858	guibg=#000000
	hi DiffDelete	ctermfg=240	ctermbg=0	guifg=#585858	guibg=#000000
	hi diffRemoved	ctermfg=240	ctermbg=0	guifg=#585858	guibg=#000000
	hi LineNr	ctermfg=240	ctermbg=0	guifg=#585858	guibg=#000000
	hi NonText	ctermfg=240	ctermbg=0	guifg=#585858	guibg=#000000
	hi SpecialComment	ctermfg=245	ctermbg=0	guifg=#8a8a8a	guibg=#000000
	hi String	ctermfg=245	ctermbg=0	guifg=#8a8a8a	guibg=#000000
	hi Boolean	ctermfg=250	ctermbg=0	guifg=#bcbcbc	guibg=#000000
	hi Debug	ctermfg=250	ctermbg=0	guifg=#bcbcbc	guibg=#000000
	hi Delimiter	ctermfg=250	ctermbg=0	guifg=#bcbcbc	guibg=#000000
	hi Exception	ctermfg=250	ctermbg=0	guifg=#bcbcbc	guibg=#000000
	hi FoldColumn	ctermfg=250	ctermbg=0	guifg=#bcbcbc	guibg=#000000
	hi Identifier	ctermfg=250	ctermbg=0	guifg=#bcbcbc	guibg=#000000
	hi Macro	ctermfg=250	ctermbg=0	guifg=#bcbcbc	guibg=#000000
	hi ModeMsg	ctermfg=250	ctermbg=0	guifg=#bcbcbc	guibg=#000000
	hi MoreMsg	ctermfg=250	ctermbg=0	guifg=#bcbcbc	guibg=#000000
	hi Question	ctermfg=250	ctermbg=0	guifg=#bcbcbc	guibg=#000000
	hi Title	ctermfg=250	ctermbg=0	guifg=#bcbcbc	guibg=#000000
	hi VertSplit	ctermfg=250	ctermbg=0	guifg=#bcbcbc	guibg=#000000
	hi Constant	ctermfg=252	ctermbg=0	guifg=#d0d0d0	guibg=#000000
	hi Define	ctermfg=255	ctermbg=0	guifg=#eeeeee	guibg=#000000
	hi DiffAdd	ctermfg=255	ctermbg=0	guifg=#eeeeee	guibg=#000000
	hi diffAdded	ctermfg=255	ctermbg=0	guifg=#eeeeee	guibg=#000000
	hi Directory	ctermfg=255	ctermbg=0	guifg=#eeeeee	guibg=#000000
	hi Function	ctermfg=255	ctermbg=0	guifg=#eeeeee	guibg=#000000
	hi Include	ctermfg=255	ctermbg=0	guifg=#eeeeee	guibg=#000000
	hi Keyword	ctermfg=255	ctermbg=0	guifg=#eeeeee	guibg=#000000
	hi Label	ctermfg=255	ctermbg=0	guifg=#eeeeee	guibg=#000000
	hi Operator	ctermfg=255	ctermbg=0	guifg=#eeeeee	guibg=#000000
	hi PreCondit	ctermfg=255	ctermbg=0	guifg=#eeeeee	guibg=#000000
	hi PreProc	ctermfg=255	ctermbg=0	guifg=#eeeeee	guibg=#000000
	hi Repeat	ctermfg=255	ctermbg=0	guifg=#eeeeee	guibg=#000000
	hi Special	ctermfg=255	ctermbg=0	guifg=#eeeeee	guibg=#000000
	hi SpecialChar	ctermfg=255	ctermbg=0	guifg=#eeeeee	guibg=#000000
	hi Statement	ctermfg=255	ctermbg=0	guifg=#eeeeee	guibg=#000000
	hi diffCommon	ctermfg=255	ctermbg=0	guifg=#eeeeee	guibg=#000000
	hi StatusLine	ctermfg=245	ctermbg=0	guifg=#8a8a8a	guibg=#000000
	hi StatusLineNC	ctermfg=236	ctermbg=0	guifg=#303030	guibg=#000000
	hi StorageClass	ctermfg=255	ctermbg=0	guifg=#eeeeee	guibg=#000000
	hi Structure	ctermfg=255	ctermbg=0	guifg=#eeeeee	guibg=#000000
	hi Todo	ctermfg=255	ctermbg=0	guifg=#eeeeee	guibg=#000000
	hi Type	ctermfg=255	ctermbg=0	guifg=#eeeeee	guibg=#000000
	hi Typedef	ctermfg=255	ctermbg=0	guifg=#eeeeee	guibg=#000000
	...
	hi Cursor	ctermfg=0	ctermbg=245	guifg=#000000	guibg=#8a8a8a
	hi CursorColumn	ctermfg=0	ctermbg=245	guifg=#000000	guibg=#8a8a8a
	hi MatchParen	ctermfg=0	ctermbg=245	guifg=#000000	guibg=#8a8a8a
	hi IncSearch	ctermfg=255	ctermbg=245	guifg=#eeeeee	guibg=#8a8a8a
	hi ColorColumn	ctermfg=0	ctermbg=250	guifg=#000000	guibg=#bcbcbc
	hi PmenuSbar	ctermfg=0	ctermbg=250	guifg=#000000	guibg=#bcbcbc
	hi PmenuSel	ctermfg=0	ctermbg=250	guifg=#000000	guibg=#bcbcbc
	hi Visual	ctermfg=0	ctermbg=250	guifg=#000000	guibg=#bcbcbc
	hi VisualNOS	ctermfg=0	ctermbg=250	guifg=#000000	guibg=#bcbcbc
	hi SpecialKey	ctermfg=0	ctermbg=255	guifg=#000000	guibg=#eeeeee
	hi iCursor	ctermfg=0	ctermbg=255	guifg=#000000	guibg=#eeeeee
	hi DiffChange	ctermfg=00	ctermbg=255	guifg=#d70000	guibg=#eeeeee
	hi diffChanged	ctermfg=00	ctermbg=255	guifg=#d70000	guibg=#eeeeee
